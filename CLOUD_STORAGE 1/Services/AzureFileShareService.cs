...
public class AzureFileShareService
{
    ...
    public async Task UploadFileAsync(string directoryName, string fileName, Stream fileStream)
    {
        try
        {
            ...
            // Ensure the file share exists, create if it does not
            await shareClient.CreateIfNotExistsAsync();

            // Get a reference to the directory (create if it doesn't exist)
        ...
        {
            Console.WriteLine($"The specified file share '{_fileShareName}' does not exist.");
        }
        catch (Exception ex)
        {
